...
;; (package! git-link :recipe (:host github :repo "Groovy-Emacs-Modes/groovy-emacs-modes"))

;; https://github.com/lassik/emacs-format-all-the-code
;; (package! git-link :recipe (:host github :repo "lassik/emacs-format-all-the-code"))
